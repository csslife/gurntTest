...
*/
  ...
  function getWidthOrHeight(elem, name, extra) {
    ...
    if (val <= 0 || val == null) {
      ...
      valueIsBorderBox = isBorderBox && (jQuery.support.boxSizingReliable || val === elem.style[
        name]);
 ...
 * @overview: ....
 * @require: nothing
 * @author: tommy_7/7/1411:49 AM
 * @arguments:
 */
(function($, D) {

  console.log("is running and body width is" + $("body").width());
